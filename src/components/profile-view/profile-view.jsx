...
export class ProfileView extends React.Component {
  ...
  editUser(e) {
    ...
    axios.put(`https://my-flix-application.herokuapp.com/users/${username}`,
      {
  ...
  onRemoveFavorite() {
    ...
    axios.delete(`https://my-flix-application.herokuapp.com/users/${username}/movies/${movie._id}`, {
      headers: { Authorization: `Bearer ${token}` }
    })
      .then((response) => {
  ...
  onDeleteUser() {
    const token = localStorage.getItem('token');
    const username = localStorage.getItem('user');
    axios.delete(`https://my-flix-application.herokuapp.com/users/${username}`, {
      headers: { Authorization: `Bearer ${token}` }
    })
      .then((response) => {
        console.log(response);
